def dbm_amount():
    ...
    # orderID = re.compile(r'單[\s]?：.*[\s]?ID：.*[\s]?(\d{6,10})', re.S | re.M) # 修正pattern@ 2022/11/11
    ...
    # df_dv360_transpose.to_excel(r"C:\Users\sebein\Desktop\結帳\DBM\2022\Sep\Monthly_File_20221110.xlsx")
